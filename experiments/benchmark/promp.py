...
def run_experiment(hyperparams):
    ...
    with tf.Session() as sess:
        ...
        algo = PPOMAML(
            ...
            num_ppo_steps=hyperparams['num_ppo_steps'],
            num_minibatches=hyperparams['num_minibatches'],
            clip_eps=hyperparams['clip_eps'],
            clip_outer=hyperparams['clip_outer'],
            target_outer_step=hyperparams['target_outer_step'],
            target_inner_step=hyperparams['target_inner_step'],
            init_outer_kl_penalty=hyperparams['init_outer_kl_penalty'],
            init_inner_kl_penalty=hyperparams['init_inner_kl_penalty'],
            adaptive_outer_kl_penalty=hyperparams['adaptive_outer_kl_penalty'],
            adaptive_inner_kl_penalty=hyperparams['adaptive_inner_kl_penalty'],
            anneal_factor=hyperparams['anneal_factor'],
        )
...
if __name__ == '__main__':
    ...
    if args.env == 'walker':
        ...
        if 'goal' in args.mode:
            ...
            hyperparams['target_inner_step'] = 0
            hyperparams['init_inner_kl_penalty'] = 5e-4
            hyperparams['adaptive_inner_kl_penalty'] = False
        else:
            hyperparams['num_ppo_steps'] = 3
            hyperparams['target_inner_step'] = 1e-2
            hyperparams['init_inner_kl_penalty'] = 1e-3
            hyperparams['adaptive_inner_kl_penalty'] = True
        hyperparams['num_minibatches'] = 1
        hyperparams['clip_eps'] = 0.3
        hyperparams['clip_outer'] = True
        hyperparams['target_outer_step'] = 0
        hyperparams['init_outer_kl_penalty'] = 0
        hyperparams['adaptive_outer_kl_penalty'] = False
        hyperparams['anneal_factor'] = 1.0
